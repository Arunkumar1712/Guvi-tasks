// Program for Sum of all numbers in an array using Anonymous fuction
...
inp.on("close", () => {
    ...
    var add=function(b){                   // Declaring the variable add to store the anonymous function
...
// Program for Sum of all numbers in an array using IIFE function
var a=userInput[0];                        // Taking Input from the user as string in array format
    var b=a.split(" ");                    // Splitting the input according to the space and stores as example [1,2,3,4,5]...
